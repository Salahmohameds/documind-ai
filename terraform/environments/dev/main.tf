###############################################################################
# DocuMind AI — Dev Environment — Main
# Wires all modules together for the dev environment
#
# Architecture matches: DocuMind AI — Cloud-Native Architecture on OCI diagram
#   VCN 10.20.0.0/16
...
#   └── Private Subnet 10.20.30.0/24  → Data (DB, Redis)
...
# ═══════════════════════════════════════════════════════════════════════════════
# 1. NETWORKING — VCN, 4 Subnets, 3 Gateways, 3 Route Tables, 4 NSGs
# ═══════════════════════════════════════════════════════════════════════════════
module "networking" {
...
# ═══════════════════════════════════════════════════════════════════════════════
# 2. IAM — Dynamic Groups + Least-Privilege Policies
# ═══════════════════════════════════════════════════════════════════════════════
module "iam" {
  source = "../../modules/iam"
...
# ═══════════════════════════════════════════════════════════════════════════════
# 3. OBJECT STORAGE — Document buckets + Terraform state
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# 4. OCIR — Container Repositories (5 microservices)
# ═══════════════════════════════════════════════════════════════════════════════
module "ocir" {
  source = "../../modules/ocir"
...
# ═══════════════════════════════════════════════════════════════════════════════
# 5. DATABASE — PostgreSQL (+ pgvector via app migration)
# ═══════════════════════════════════════════════════════════════════════════════
module "database" {
...
# ═══════════════════════════════════════════════════════════════════════════════
# 6. OKE — Kubernetes Cluster + Node Pool (VCN-native pod networking)
# ═══════════════════════════════════════════════════════════════════════════════
module "oke" {
  source = "../../modules/oke"
...
# ═══════════════════════════════════════════════════════════════════════════════
# 7. LOAD BALANCER — OCI Flexible LB (Public)
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# 8. MONITORING — Alarms, Notifications, Logging
# ═══════════════════════════════════════════════════════════════════════════════
module "monitoring" {
